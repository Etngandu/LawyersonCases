...
namespace LawyerOffice.Data.EF.Repositories
{
    ...
    /// </summary>
    public class AsyncCaseRepository: AsyncRepository<Case>, IAsyncCaseRepository
        {
        private readonly IDataContextStorageContainer<OfficeLawyerContext> _cdataContextFactory;
        public AsyncCaseRepository(IDataContextStorageContainer<OfficeLawyerContext> cdataContextFactory) : base(cdataContextFactory)
        {
